...
const BlogEditor = ({ content, blogId, editable }: BlogEditorProps) => {
    const { editor } = useBlogEditor({ initialContent: content, blogId, editable })
    ...
    return (
        <div
            ...
            <EditorContent editor={editor}
                className="no-scrollbar h-[85vh] w-full overflow-y-auto rounded border-2 border-zinc-700 bg-zinc-900 outline-none"
            />
